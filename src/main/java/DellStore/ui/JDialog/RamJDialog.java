...
public class RamJDialog extends javax.swing.JDialog {
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        ...
        String dungluong = txt_dungluong.getText().trim(); // không validate
        String loai = txt_loai.getText().trim();
        int trangThai = rdo_conhang.isSelected() ? 1 : 0;

// 1️⃣ Kiểm tra bắt buộc
        if (ten.isEmpty() || loai.isEmpty() || dungluong.isEmpty()) {
            JOptionPane.showMessageDialog(this,
                    "Vui lòng nhập đầy đủ tên và loại RAM và Dung Lượng",
                    "Lỗi",
        ...
        JOptionPane.showMessageDialog(this, "Thêm RAM thành công!");
        loadTableRAM(); // cập nhật bảng
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn RAM để sửa!");
            return;
        }

// Lấy object RAM theo dòng được chọn
        Ram ramUpdate = listRAM.get(row);
...
// 1️⃣ Kiểm tra bắt buộc
        if (ten.isEmpty() || loai.isEmpty() || dungluong.isEmpty()) {
            JOptionPane.showMessageDialog(this,
                    "Vui lòng nhập đầy đủ tên và loại RAM",
                    "Lỗi",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
        int confirm = JOptionPane.showConfirmDialog(this,
                "Bạn có chắc muốn cập nhật ram này không?",
                "Xác nhận",
...
// 2️⃣ Cập nhật thông tin vào object
        ramUpdate.setTen(ten);
        ramUpdate.setDung_luong(dungluong);
        ramUpdate.setLoai(loai);
        ramUpdate.setTrang_thai(trangThai);

// 3️⃣ Gọi DAO để cập nhật
        ramDAOImpl dao = new ramDAOImpl();
        dao.update(ramUpdate);

// 4️⃣ Thông báo và reload bảng
        JOptionPane.showMessageDialog(this, "Cập nhật RAM thành công!");
        loadTableRAM();  // reload bảng sau khi sửa
