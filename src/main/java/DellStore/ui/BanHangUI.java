...
public class BanHangUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã SP", "Tên SP", "Đơn Giá", "Chất liệu", "Giảm Giá", "Thành Tiền"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BanHangUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
